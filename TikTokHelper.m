...
// 自动关注2 专用: fromPageType=12 (0xC) 突破100关注限制
- (void)followUID2:(NSString *)uid {
    ...
    id ctx = [[CtxCls alloc] init];
    [ctx setValue:user forKey:@"user"];
    [ctx setValue:@(12) forKey:@"fromPageType"];   // 0xC = 突破100限制
    [ctx setValue:@(-1) forKey:@"prePageType"];    // -1 = 未设置
    [ctx setValue:@(-1) forKey:@"channelID"];      // -1 = 未设置
